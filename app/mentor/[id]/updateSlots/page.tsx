...
import {Row,Col,Space,Card,ConfigProvider,Dropdown,Input,Popover,theme,Descriptions,DatePicker,Flex,Avatar,Select,Form} from 'antd';
                          ...
                          <Col xs={{span:24}} lg={{span:12}}>
                              <Form
                                ...
                                <Form.Item 
                                  ...
                                  >
                                    <Select placeholder="select your slot duration" defaultValue={hr} value={hr} onChange={handleChange}>
                                ...
                                <Form.Item 
                                  ...
                                  >
                                    {hr == 1 && <Select placeholder="select your slot">
                                    ...
                                    {hr == 2 && <Select placeholder="select your slot">
                                    ...
                                    {hr == 3 && <Select placeholder="select your slot">
