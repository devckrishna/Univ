...
import {Row,Col,Button, Divider,Space,Card,Avatar, Pagination,ConfigProvider,Dropdown,Input,Popover,theme} from 'antd';
                ...
                <PageContainer content="">
                    <div>
                        <div style={{margin:'20px'}}>
                            <Divider orientation="center"><h2>Most Recent Blogs</h2></Divider>
                            <Row gutter={[48,48]}>
                        ...
                        <div style={{margin:'20px'}}>
                            {/* <Row> */}
                                <Divider orientation="center"><h2>See All Posts</h2></Divider>
                                <Row gutter={[48,48]}>
                                ...
                                <Row> <Pagination defaultCurrent={1} total={50} showLessItems={true} /> </Row>
